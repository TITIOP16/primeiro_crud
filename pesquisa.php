  ...
  <body>
    ...
    <?php 
      ...
      SELECT pessoas.cod_pessoa, 
        ...
        pessoas.foto, 
        sexo.nome as cod_sexo
      FROM pessoas 
      inner join sexo on (pessoas.cod_sexo = sexo.id) 
        ...
        <div class="col">
          ...
          <nav class="navbar navbar-light bg-light">
            <form class="form-inline" action="pesquisa.php" method="POST">
              ...
              <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Buscar Cadastro</button>
            </form>
          </nav>
    ...
    <div class="modal fade" id="confirma" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <p>Confirmar exclusão de cadastro <b id="nome_pessoa">Nome</b>?</p>
          </div>
